...
<head>
  ...
  <title>TimeSheet | Services</title>
...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">
          <h2 class="content-heading">Timesheet | <b>Services</b></h2>
            ...
            <div class="row">
            <div class="col-lg-6">
            <button type="button" class="btn btn-secondary icon-left mr-3" id="add_service">Ajouter un nouveau service <span class="btn-icon iconfont iconfont-plus-v1"></span></button>
            ...
            <table class="datatable table table-striped" id="table_service">
            <thead>
            <tr>
            <th>Nom Service</th>
            <th>Fonction</th>
...
<div class="lightbox_container">
  ...
  <div class="lightbox_content">
    ...
    <form class="form add" id="form_service" data-id="" novalidate>
      <div class="input_container">
        <label for="nom">Nom Service : <span class="required">*</span></label>
...
<script charset="utf-8" src="module/timesheet/table/js/webapp_liste_service.js"></script>
