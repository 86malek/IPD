...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">
          <h2 class="content-heading">Tableaux des données : <b>CNIL</b></h2>
            ...
            <?php if(!checkAdmin()) { ?>
            <div class="col-lg-6">
            <button type="button" class="btn btn-info icon-left mr-3" id="add_rapport">Ajouter une nouvelle entrée <span class="btn-icon iconfont iconfont-plus-v1"></span></button>
            </div>
            ...
            <?php }else{ ?>
           	<div class="col-lg-6">
            <a class="btn btn-success icon-left mr-3" href="CnilRapport">Retour aux statistiques <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>              
            </div>
			<div class="col-lg-6" style="text-align:right">
            <a class="btn btn-primary icon-left mr-3" href="javascript:window.location.reload()">Rafraîchissement <span class="btn-icon iconfont iconfont-refresh"></span></a>
...
<div class="lightbox_container">
  ...
  <div class="lightbox_content">
            ...
            <label for="nature">RECUS : <span class="required">*</span></label>
            <div class="field_container">
                    <input type="number" class="form-control" id="ch1" name="ch1" required>
            </div>
            </div>
            
            <div class="input_container">
            <label for="nature">A SUPPRIMER : <span class="required">*</span></label>
            <div class="field_container">
            ...
            <div class="input_container">
            <label for="nature">DÉSABO : <span class="required">*</span></label>
            <div class="field_container">
                    <input type="number" class="form-control" id="ch3" name="ch3" required>
            </div>
            </div>
...
<?php if (checkAdmin()) { ?>   
<script charset="utf-8" src="module/cnil/table/js/webapp_cnil_admin.js"></script>
<?php }else{ ?>
<script charset="utf-8" src="module/cnil/table/js/webapp_cnil.js"></script>
<?php } ?>
