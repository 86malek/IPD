...
<div class="page-content">
    <div class="container-fluid">
      	...
      	<h2 class="content-heading">Données : <b>CNIL</b></h2>       
        <div class="main-container">
        
        <div class="container-block">            
        <div class="row">
        <div class="col-lg-6">
        <a class="btn btn-secondary icon-right mb-3 mr-3" href="CnilRapportGlobal">LISTE GLOBALE</a>  
        ...
        <div id="modal-settings" class="modal fade custom-modal-tabs">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form action="CnilDetailsJour" method="post" name="filtre">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <select class="form-control" data-placeholder="Tous les intervenants disponibles" name="collab">
                                <option></option>
                                <?php
								$query = $bdd->prepare("SELECT user_name, user_id FROM `cnil_traitment` WHERE user_id <> 0 GROUP BY user_id");
								$query->execute();	
        ...
        <table class="datatable table table-striped" id="table_gestion_rapport_cnil">
            <thead>
            	<tr>
                        <th></th>
...
<script src="module/cnil/table/js/webapp_gestion_cnil.js"></script>
