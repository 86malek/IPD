...
<head>
  ...
  <title>WEBMASTERS / RÉSUMÉ - PRIMES</title>
...
<link rel="stylesheet" href="module/qualite/table/css/layout_qualite.css">
...
<div class="page-content">
  <div class="container-fluid">
      	...
      	<h2 class="content-heading">WEBMASTERS / <b>RÉSUMÉ - PRIMES</b></h2>       
        <div class="main-container">
        
        <div class="container-block">            
        <div class="row">
        <div class="col-lg-6">
        <a class="btn btn-secondary icon-right mb-3 mr-3" href="WebsRapportCollab">Liste des rapport globle</a>  
        <!--
        ...
        <a class="btn btn-primary icon-right mb-3 mr-3"  href="#" id="refresh">Rafraîchissement du tableau<span class="btn-icon iconfont iconfont-refresh"></span></a>
        </div>
        </div>       
        </div> 
        ...
        <table class="datatable table table-striped" id="table_gestion_global_primes_webs">
            <thead>
                <tr>                    
                    <th>WEBMASTER</th> 
                    <th>TRIMESTRE</th>
...
<script src="module/webmaster/table/js/webapp_gestion_webs_integration.js"></script>
