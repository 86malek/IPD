...
<head>
    ...
    <title>Gestion des primes - Paramétrage des périodes</title>
...
<div class="page-content">
    <div class="container-fluid">
      	...
      	<h2 class="content-heading">Module : Gestion des primes > <b>Gestion des périodes</b></h2> 
        ...
        <a class="btn btn-info" href="#"  id="add_tri">Ajouter une nouvelle période</a>    
        </div>
        ...
        <table class="datatable table table-striped" id="table_webs_accomp_tri">
            <thead>
                <tr> 
...
<div class="lightbox_container">
  ...
  <div class="lightbox_content">
        ...
        <div class="input_container">
                <label for="nom">Non de la Période : <span class="required">*</span></label>
        ...
        <div class="input_container">
                ...
                <div class="field_container">
                    <input id="annee" name="annee" type="number" maxlength="4" minlength="4" value="" class="form-control" required/>
                </div>
        </div>

        <div class="input_container">
            <label for="intervalle">Intervalle : <span class="required">*</span></label>
            <div class="field_container">
                    <input id="custom-ranges" type="text" placeholder="" class="js-date-custom-ranges form-control" name="intervalle">
            </div>
        </div>
...
<script src="module/webmaster/table/js/webapp_gestion_webs_accomp_tri.js"></script>
