...
<div class="page-content">
    <div class="container-fluid">
      	...
      	<h2 class="content-heading">Module : <b>Gestion des primes</b></h2> 
        ...
        <div class="row">
        <div class="col-lg-9">
            <a class="btn btn-info mr-3" href="#"  id="add_rapport">Ajouter une nouvelle donnée</a>
            <a class="btn btn-warning mr-3" href="WebsAccompTri">Gestion des Trimestres</a>
            <a class="btn btn-danger mr-3" href="WebsAccompErr">Gestion des erreurs</a> 
        </div>
        ...
        <table class="datatable table table-striped" id="table_webs_accomp">
            <thead>
                <tr>
...
<script src="module/webmaster/table/js/webapp_gestion_webs_accomp.js"></script>
