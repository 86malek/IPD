...
<head>
  ...
  <title>Webmasters Integration</title>
...
<div class="page-content">
    <div class="container-fluid">
      	...
      	<h2 class="content-heading">Webmasters / <b>INTÉGRATIONS et CRÉATIONS</b></h2>       
        ...
        <a class="btn btn-primary icon-right mb-3 mr-3"  href="#" id="refresh">Rafraîchissement <span class="btn-icon iconfont iconfont-refresh"></span></a>
        </div>
        </div>       
        </div> 
