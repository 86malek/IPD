...
<head>
  ...
  <title>Webmasters | Génaration Clic Leads Cryptogramme 5</title>
...
<div class="page-content">
        ...
        <div class="container-fluid">
          <h2 class="content-heading"><b>Webmasters | Génaration Clic Leads Cryptogramme 5</b></h2>
          ...
          <div class="main-container">
            ...
            <div class="row">
            <div class="col-lg-9">
            <a href="WebsAjoutGenClicLeads" class="btn btn-info icon-right btn-sm mr-3" id="webs_clic_lead_ajout">Ajouter un nouveau fichier pour cryptage <span class="btn-icon iconfont iconfont-circle-check"></span></a>
            ...
            <table class="datatable table table-striped" id="table_crypte">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>EMAIL</th>
...
<script charset="utf-8" src="module/webmaster/table/js/webapp_webmaster_crypte.js"></script>
