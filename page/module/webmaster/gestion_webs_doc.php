...
<div class="page-content">
    <div class="container-fluid">
      	...
      	<h2 class="content-heading">Webmasters / <b>DOCUMENTS</b></h2>       
        <div class="main-container">
        
        <div class="container-block">            
        <div class="row">
        <div class="col-lg-6">
        <a class="btn btn-success icon-left btn-sm mr-3" href="WebsAjout">Ajouter un document<span class="btn-icon iconfont iconfont-plus-v1"></span></a>
        </div>
...
<script src="module/webmaster/table/js/webapp_webs_doc.js"></script>
