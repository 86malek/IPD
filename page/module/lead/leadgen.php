...
<head>
  ...
  <title>Lead Gen - Téléphonie / IPD</title>
...
<div class="page-content">
        ...
        <div class="container-fluid">
          <h2 class="content-heading">Lead Gen / Téléphonie</h2>
          ...
          <div class="main-container">
            ...
            <div class="row">
            <div class="col-lg-12">
            <button type="button" class="btn btn-info icon-right mr-3" id="add_lead">Ajouter une nouvelle entrée <span class="btn-icon iconfont iconfont-circle-check"></span></button>
            
            <a class="btn btn-primary icon-right mr-3" href="leadgen_import.php">Importer un fichier  <span class="btn-icon iconfont iconfont-upload"></span></a>
            </div>           
            </div>
            ...
            <table class="datatable table table-striped" id="table_leadgen">
                <thead>
                    <tr>
                        <th>Opération</th>
                        <th>Participant</th>
...
<script charset="utf-8" src="table/webapp_lead.js"></script>
