...
<?php include("include/sidebar.php");?>
	...
	<div class="page-content">
        <div class="container-fluid">
					...
					if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
					{
						...
						{						
								...
								$db_connection = mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME);
								  ...
								  $query_efaacer = "TRUNCATE TABLE lead_gen";
								  ...
								  if (!$query_efaacer){
									...
									if ($fichier !== FALSE) {
									   ...
									   while (($data = fgetcsv($fichier, 4096, ";"))) {
										...
										$query = "INSERT INTO lead_gen(id, operation_qld, nb_participant_qld, objectif_qld, realiser_qld, nature_objet_qld, date_debut_qld, date_fin_qld) VALUES ('','$champ1','$champ2', '$champ3', '$champ4', '$champ5', '$champ7', '$champ8')";
									...
									echo "<script type='text/javascript'>document.location.replace('leadgen.php');</script>";
            ...
            <form method="post" action="leadgen_import.php"  enctype="multipart/form-data">           
