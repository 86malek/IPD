...
<head>
  ...
  <title>Qualité de données / IPD</title>
...
<div class="page-content">
        ...
        <div class="container-fluid">
          <h2 class="content-heading">Qualité de données</h2>
          ...
          <div class="main-container">
            ...
            <div class="row">
            <div class="col-lg-12">
            <button type="button" class="btn btn-success icon-right mr-3" id="add_qld">Ajouter une nouvelle entrée <span class="btn-icon iconfont iconfont-circle-check"></span></button>
            
            <a class="btn btn-warning icon-right mr-3" href="qld_import.php">Importer un fichier  <span class="btn-icon iconfont iconfont-upload"></span></a>
            </div>           
            </div>
            ...
            <table class="datatable table table-striped" id="table_qld">
                <thead>
                    <tr>
                        <th>Opération</th>
                        <th>Participant</th>
  ...
  <div class="lightbox_content">
            ...
            <form class="form add" id="form_company" data-id="">
              ...
              <div class="input_container">
                ...
                <div class="field_container">
                  <input type="number" step="1" min="0" name="object" id="object" value=""  class="form-control" required>
                </div>
              </div>
              <div class="input_container">
...
<script charset="utf-8" src="table/webapp_qld.js"></script>
