...
<head>
  ...
  <title>Qualité de données - import / IPD</title>
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
              <div class="widget widget-welcome">
                ...
                <h4 class="widget-welcome__message-l1">Importation BD qualité de données</h4>                  
                </div>
				...
				{ 
					...
					if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
					{
						...
						{						
								...
								$query_efaacer = "TRUNCATE TABLE qualite_de_donnees";
								...
								$champ7 = date('Y-m-d', strtotime(str_replace('/', '-', $col[5])));
								
								$champ8 = date('Y-m-d', strtotime(str_replace('/', '-', $col[6])));
								...
								$query = "INSERT INTO qualite_de_donnees(id, operation_qld, nb_participant_qld, objectif_qld, realiser_qld, nature_objet_qld, date_debut_qld, date_fin_qld) VALUES('','$champ1','$champ2', '$champ3', '$champ4', '$champ5', '$champ7', '$champ8')";
								...
								fclose($fichier);
									...
									echo "<script type='text/javascript'>document.location.replace('qld.php');</script>";
            ...
            <form method="post" action="qld_import.php"  enctype="multipart/form-data">           
            ...
            <button class="btn btn-info btn-lg mb-2 mr-3 icon-right" name="doSubmitdata" type="submit" id="doSubmitdata" value="download">Alimenter la base qualité de données</button>
            <a class="btn btn-danger btn-lg mb-2 mr-3 icon-right" name="doSubmitdatamodif" href="qld.php">Annuler et retour à la liste</a>
			</div>
