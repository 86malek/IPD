...
$query->bindParam(":id_cat", $_GET['id'], PDO::PARAM_INT);
$query->execute();
$doc = $query->fetch();
$query->closeCursor();	
...
<head>
  ...
  <title>Synthése journalière DOSSIERS CLIENT: Partie CONTACT</title>
...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          <h2 class="content-heading">Synthèse journalière dossier CONTACT: <b><?php echo $document; ?></b></h2>
          <div class="main-container">
  			<div class="container-block">
            <div class="row">
            <div class="col-lg-6">
            <a class="btn btn-success icon-left mr-3" href="Contact-<?php echo $_GET['idcatt'];?>">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
            </div>
            ...
            <table class="datatable table table-striped" id="table_cat_fichier_client_detail" data-id="<?php echo $_GET['id']?>">
            <thead>
            <tr>
            <th>JOUR</th>
            <th>INTERVENANT</th> 
...
<script charset="utf-8" src="module/client/table/js/webapp_cat_fichier_client_detail_jour_contact.js"></script>
