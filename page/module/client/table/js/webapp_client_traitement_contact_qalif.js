...
var qalif = $('#table_traitement').attr('data-qalif');
  ...
  var table_companies = $('#table_traitement').dataTable({
	 "bStateSave": true,
	  "ajax": "module/client/table/php/data_client_traitement.php?job=get_traitement_contact_qualif&id_import=" + id_import+"&qalif=" + qalif+"&id_user=" + id_user,
	  "deferRender": true,
    "columns": [
    ...
    request.done(function(output){
      ...
      if (output.result == 'success'){
        ...
        $('#form_company .field_container').removeClass('valid').removeClass('error');
			...
			$('#form_company #nsiret').val(output.data[0].nsiret);
			...
			$('#form_company #tel22').val(output.data[0].tel2);
			
			$('#form_company #ors').val(output.data[0].ors);
			$('#form_company #onsiret').val(output.data[0].osiret);
			$('#form_company #oad').val(output.data[0].oad);
			$('#form_company #ocp').val(output.data[0].ocp);
			$('#form_company #oville').val(output.data[0].oville);
			$('#form_company #otel').val(output.data[0].otel);
