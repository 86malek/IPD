...
$(document).ready(function(){
    ...
    "ajax": "module/client/table/php/data_client_traitement.php?job=get_traitement_admin&id_import=" + id_import +"&id_cat_mere=" + id_cat_mere,
    "columns": [
  ...
  $(document).on('click', '#function_edit_web', function(e){
    ...
    request.done(function(output){
      if (output.result == 'success'){
        $('.lightbox_content h2').text('Traitement / Correction de la LIGNE (ADMIN)');
        $('#form_company button').text('Enregistrement de la correction');
