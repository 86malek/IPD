...
<head>
  ...
  <title><?php echo $titre_dossier; ?> / Objectifs</title>
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="content-description">Dossier CLIENT</div>      	
      ...
      <div class="main-container">
        ...
        <div class="col-lg-6">
          <a class="btn btn-success icon-left btn-sm" href="Client-<?php echo $_GET['idcatt']; ?>">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
...
<script src="module/client/table/js/webapp_cat_fichier_client_detail_obj.js"></script>
