...
<head>
  ...
  <title>Dossiers CLIENTS - Objectifs : Partie CONTACT</title>
...
<link rel="stylesheet" href="css/layout_admin_collect.css">
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="content-description">Dossiers CLIENT : Partie CONTACT</div>      	
      ...
      <div class="main-container">
        ...
        <div class="col-lg-6">
          <a class="btn btn-success icon-left btn-sm" href="Contact">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
...
<script src="module/client/table/js/webapp_cat_fichier_client_detail_obj_contact.js"></script>
