...
<head>
  ...
  <title>Synthése journalière DOSSIERS CLIENT</title>
...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          <h2 class="content-heading">Synthèse journalière dossier : <b><?php echo $document; ?></b></h2>
          <div class="main-container">
  			<div class="container-block">
            <div class="row">
            <div class="col-lg-6">
            <a class="btn btn-success icon-left mr-3" href="Client-<?php echo $_GET['idcatt'];?>">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
            </div>
...
<script charset="utf-8" src="module/client/table/js/webapp_cat_fichier_client_detail_jour.js"></script>
