...
<head>
  ...
  <title>OBJECTIFS - CARTES VISITES (LK)</title>
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="content-description">Cartes Visites (LK)</div>      	
      ...
      <div class="main-container">
        ...
        <div class="col-lg-6">
          <a class="btn btn-success icon-left btn-sm" href="Linkedin">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
...
<script src="module/linkedin/table/js/webapp_cat_fichier_acide_detail_obj.js"></script>
