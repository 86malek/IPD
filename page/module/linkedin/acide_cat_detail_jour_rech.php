...
<head>
  ...
  <title>RECHERCHE CARTES VISITES (LK)</title>
...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          <h2 class="content-heading">RECHERCHE CARTES VISITES (LK)</h2>
          ...
          <div class="main-container">
            ...
            <div class="row">
            <div class="col-lg-6">
            <a class="btn btn-success icon-left btn-sm  mr-3" href="Linkedin">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
...
<script charset="utf-8" src="module/linkedin/table/js/webapp_cat_fichier_acide_detail_rech.js"></script>
