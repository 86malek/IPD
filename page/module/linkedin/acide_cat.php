...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          <h2 class="content-heading">CARTES VISITES (LK)</h2>
          ...
          <div class="main-container">
            ...
            <a class="btn btn-primary icon-right btn-sm mr-3" href="javascript:window.location.reload()">Rafraîchissement deu tableau <span class="btn-icon iconfont iconfont-refresh"></span></a>
            </div>
            </div>
...
<div class="lightbox_container">
  ...
  <div class="lightbox_content">
            ...
            <div class="input_container">
            	<label for="reporting">Nom dossier : <span class="required">*</span></label>
