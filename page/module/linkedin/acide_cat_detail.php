...
<head>
  ...
  <title>Synthése détaillée des fichiers CARTES VISITES (LK)</title>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          ...
          <div class="main-container">
            ...
            <div class="row">
            <div class="col-lg-6">
            <a class="btn btn-success btn-sm icon-left mr-3" href="Linkedin">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
            </div>
...
<script charset="utf-8" src="module/linkedin/table/js/webapp_cat_fichier_acide_detail.js"></script>
