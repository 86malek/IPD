...
<head>
  ...
  <title>DATA Acide - Catégories</title>
...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          <h2 class="content-heading">Catégorie de fichier Acide</h2>
          <div class="main-container">
  			<div class="container-block">
            <div class="row">
            
            <div class="col-lg-6">
            <button type="button" class="btn btn-success icon-left btn-sm mr-3" id="add_cat_fichier">Ajouter une Catégorie <span class="btn-icon iconfont iconfont-plus-v1"></span></button>
            <a class="btn btn-info icon-left btn-sm mr-3" href="DataAcide">Retour à la liste des fichiers</a>
            </div>
            <div class="col-lg-3">
...
<div class="lightbox_container">
  ...
  <div class="lightbox_content">
    ...
    <h2></h2>
    <form class="form add" id="form_cat_fichier" data-id="" novalidate>
...
<script src="module/acide_autre/table/js/webapp_cat_fichier_data_acide.js"></script>
