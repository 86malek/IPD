$(document).ready(function() {
	var date = $("#table_cat_fichier_acide_rech_tb_siret").attr("data-date");
	var collab = $("#table_cat_fichier_acide_rech_tb_siret").attr("data-collab");
	function d(a, b) {
	...
	function l() {
		...
		g = $("#table_cat_fichier_acide_rech_tb_siret").dataTable({
			bStateSave: !0,
