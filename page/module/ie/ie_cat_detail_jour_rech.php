...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          <h2 class="content-heading">RECHERCHE Sirétisation (DATA)</h2>
          ...
          <div class="main-container">
            ...
            <div class="row">
            <div class="col-lg-6">
            <a class="btn btn-success icon-left btn-sm mr-3" href="IE">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
            ...
            <table class="datatable table table-striped" id="table_cat_fichier_acide_rech"  data-date="<?php echo $_POST['intervalle'];?>"  data-collab="<?php echo $_POST['collab'];?>">
            <thead>
            <tr>
            <th>JOUR</th>
            <th>INTERVENANT</th> 
...
<script charset="utf-8" src="module/ie/table/js/webapp_cat_fichier_ie_detail_rech.js"></script>
