$(document).ready(function(){
  ...
  var table_companies = $('#table_traitement').dataTable({
    ...
    "ajax": "module/ie/table/php/data_ie_traitement.php?job=get_traitement&id_import=" + id_import + "&name_user=" + name_user +"&id_user=" + id_user +"&mode=" + mode_page +"&reporting=" + reporting,
    "columns": [
	{ "data": "alerte",      "sClass": "" },
  ...
  $(document).on('click', '#function_edit_web', function(e){
    ...
    var id      = $(this).data('id');
    var request = $.ajax({
      url:          'module/ie/table/php/data_ie_traitement.php?job=get_traitement_add',
      cache:        false,
      data:         'id=' + id,
      dataType:     'json',
  ...
  $(document).on('submit', '#form_company.edit', function(e){
    ...
    if (form_company.valid() == true){
      ...
      var request   = $.ajax({
        url:          'module/ie/table/php/data_ie_traitement.php?job=edit_traitement&id=' + id + '&fin='+ dateTime_fin,
        cache:        true,
        data:         form_data,
        dataType:     'json',
        contentType:  'application/json; charset=utf-8',
