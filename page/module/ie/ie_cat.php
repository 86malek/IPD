...
$query = $bdd->prepare("SELECT nbligne_objectif, nbheure_objectif FROM data_cat_synthese_fiche_obj_ie WHERE debut_objectf <= '".date("Y-m-d")."' AND fin_objectif >= '".date("Y-m-d")."' ORDER BY id_objectif DESC LIMIT 0, 1");
$query->execute();
$donnees = $query->fetch();
...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          <h2 class="content-heading">INDUSTRIE EXPLORER</h2>
          ...
          <div class="main-container">
            ...
            <div class="row">
            <div class="col-lg-6">
            <a class="btn btn-success icon-left btn-sm mr-3" href="IEAjout">Ajouter un dossier<span class="btn-icon iconfont iconfont-plus-v1"></span></a>
            <a class="btn btn-secondary icon-left btn-sm mr-3" href="IEObj">Gestion des objectifs</span></a>
        	...
        	<div id="modal-settings" class="modal fade custom-modal-tabs">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form action="IERech" method="post" name="filtre">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <select class="form-control" data-placeholder="Tous les intervenants disponibles" name="collab">
                                <option></option>
                                <?php
								$query = $bdd->prepare("SELECT user_name, user_id FROM `data_ie` WHERE user_id <> 0 GROUP BY user_id");
								$query->execute();	
...
<script src="module/ie/table/js/webapp_cat_fichier_ie.js"></script>
