...
<head>
  ...
  <title>NOMINATION - Objectifs</title>
    ...
    <div class="container-fluid">
      ...
      <div class="main-container">
        ...
        <div class="col-lg-6">
          ...
          <button type="button" class="btn btn-secondary icon-left btn-sm" id="add_nomination_obj">Ajouter un Objectif <span class="btn-icon iconfont iconfont-plus-square"></span></button>
        ...
        <table class="datatable table table-striped" id="table_gestion_traitement_nomination_obj">
            <thead>
                <tr>                    
                    <th>NB.FICHES</th>                    
                    <th>NB.HEURES</th>
...
<div class="lightbox_container">
  ...
  <div class="lightbox_content">
      ...
      <h2></h2>
            ...
            <form class="form add" id="form_obj" data-id="">            
...
<script src="module/nomination/table/js/webapp_acide_gestion_traitement_nomination_obj.js"></script>
