...
<head>
  ...
  <title>Nomination - Enrichissement métier</title>
...
<div class="page-content">
    <div class="container-fluid">
      	...
      	<h2 class="content-heading"><b>Enrichissement métier</b></h2>
        <div class="content-description">Nomination</div>      	
      ...
      <div class="main-container">
        ...
        <div class="col-lg-6">
          <a class="btn btn-success icon-left btn-sm" href="NominationBiblio">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
          <button type="button" class="btn btn-secondary icon-left btn-sm" id="add_nomination_enrichissement">Ajouter un Enrichissement métier <span class="btn-icon iconfont iconfont-plus-square"></span></button>
        ...
        <table class="datatable table table-striped" id="table_gestion_traitement_nomination_enrechisement">
            <thead>
                <tr>                    
                    <th>DATE</th>                    
                    <th>PREFIXE</th>
                    <th>CODE DE RECHERCHE</th>
                    <th>ACTIF</th>
                    <th>ACTION</th>
                </tr>
            </thead>
...
<div class="lightbox_container">
  ...
  <div class="lightbox_content">
      ...
      <h2></h2>
            ...
            <form class="form add" id="form_enrichissement" data-id="">   
            
            
            <div class="input_container">
            <label for="Prefix">PREFIX NOM : <span class="required">*</span></label>
            ...
            <div class="input_container">
            <label for="Nomination du prefix">CODE DE RECHERCHE : <span class="required">*</span></label>
            <div class="field_container">
...
<script charset="utf-8" src="module/nomination/table/js/webapp_acide_gestion_traitement_nomination.js"></script>
