...
<head>
  ...
  <title>HARD BOUNCE (HB) - OBJECTIFS</title>
...
<div class="page-content">
    <div class="container-fluid">
      	...
      	<h2 class="content-heading">GESTION : <b>OBJECTIFS</b></h2>
        <div class="content-description">HARD BOUNCE (HB)</div>      	
      ...
      <div class="main-container">
        ...
        <div class="col-lg-6">
          <a class="btn btn-success icon-left btn-sm" href="HB">Retour à la synthèse globale <span class="btn-icon iconfont iconfont-step-arrow-left"></span></a>
...
<script src="module/hb/table/js/webapp_cat_fichier_acide_detail_obj.js"></script>
