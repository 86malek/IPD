...
<link rel="stylesheet" href="module/doc/table/css/layout_doc.css">
...
<div class="page-content">
    <div class="container-fluid">
      	...
      	<h2 class="content-heading">Gestion / <b>DOCUMENTS</b></h2>       
        <div class="main-container">
        
        <div class="container-block">            
        <div class="row">
        <div class="col-lg-6">
        <a class="btn btn-success icon-left btn-sm mr-3" href="DocAjout">Ajouter un document<span class="btn-icon iconfont iconfont-plus-v1"></span></a>
        </div>
        <div class="col-lg-3"></div>
        <div class="col-lg-3" style="text-align:right">             
        <a class="btn btn-primary icon-right btn-sm mb-3 mr-3"  href="#" id="refresh">Rafraîchissement du tableau<span class="btn-icon iconfont iconfont-refresh"></span></a>
        </div>
        </div>       
        </div> 
        ...
        <table class="datatable table table-striped" id="table_gestion_doc_webs">
            <thead>
                <tr>                    
                    <th>ID</th> 
                    <th>NOM</th>
...
<div class="lightbox_container">
  ...
  <div class="lightbox_content">
        ...
        <div class="input_container">
            <label for="reporting">Nom du document : <span class="required">*</span></label>
...
<script src="module/doc/table/js/webapp_doc.js"></script>
