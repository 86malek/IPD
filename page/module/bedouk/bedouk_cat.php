...
$query = $bdd->prepare("SELECT nbligne_objectif, nbheure_objectif FROM data_cat_synthese_fiche_obj_bedouk WHERE debut_objectf <= '".date("Y-m-d")."' AND fin_objectif >= '".date("Y-m-d")."' ORDER BY id_objectif DESC LIMIT 0, 1");
$query->execute();
$donnees = $query->fetch();
...
<link rel="stylesheet" href="module/bedouk/table/css/layout_bedouk.css">
...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          <h2 class="content-heading">Module Bedouk</h2>
          ...
          <div class="main-container">
            ...
            <div class="row">
            <div class="col-lg-6">
            <a class="btn btn-success icon-left btn-sm mr-3" href="SiretAjout">Ajouter un dossier<span class="btn-icon iconfont iconfont-plus-v1"></span></a>
            <a class="btn btn-secondary icon-left btn-sm mr-3" href="SiretObj">Gestion des objectifs</span></a>
        	...
        	<div id="modal-settings" class="modal fade custom-modal-tabs">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form action="SiretRech" method="post" name="filtre">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <select class="form-control" data-placeholder="Tous les intervenants disponibles" name="collab">
                                <option></option>
                                <?php
                								$query = $bdd->prepare("SELECT user_name, user_id FROM `data_bedouk` WHERE user_id <> 0 GROUP BY user_id");
                								$query->execute();	
            ...
            <table class="datatable table table-striped" id="table_cat_fichier">
            <thead>
            <tr>
            <th>DOSSIER</th>
            <th>STATUT</th>
...
<script src="module/bedouk/table/js/webapp_cat_fichier_bedouk.js"></script>
