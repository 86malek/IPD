...
<head>
  ...
  <title>Synthése détaillée Collectivité</title>
...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">     
          <h2 class="content-heading">Synthèse détaillée des fichiers Collectivité</h2>
          <div class="main-container">
            ...
            <table class="datatable table table-striped" id="table_collect_detail" data-id="<?php echo $_GET['id']?>">
            <thead>
            <tr>
            <th>LOT</th>
            <th>INTERVENANT</th> 
...
<script charset="utf-8" src="module/collectivite/table/js/webapp_collectivite_detail.js"></script>
