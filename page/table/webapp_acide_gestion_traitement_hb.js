$(document).ready(function(){
  var table_companies = $('#table_gestion_traitement_hb').dataTable({
    "ajax": "table/data_acide_gestion_traitement_hb.php?job=get_gestion_traitement_hb",
    "columns": [
	  ...
	  { "data": "countajout", "sClass": "company_name" },
	  { "data": "countmodif", "sClass": "company_name" },
	  { "data": "countsupp", "sClass": "company_name" },
	  { "data": "countbo", "sClass": "company_name" }
    ],
    dom: 'Bfrtip',
	"buttons": [
            {
  ...
  $(document).on('click', '#del', function(e){
    ...
    if (confirm("Confirmation de supprission du '" + company_name + "' !!")){
      ...
      var id      = $(this).data('id');
      var request = $.ajax({
        url:          'table/data_acide_gestion_traitement_hb.php?job=delete_gestion_traitement_hb&id=' + id,
        cache:        false,
        dataType:     'json',
        contentType:  'application/json; charset=utf-8',
        type:         'get'
